...
CHANNELS = {
    1: {"url": f"{BASE_URL}=1&subtype=1", "label": ""},
    2: {"url": f"{BASE_URL}=2&subtype=1", "label": ""},
    13: {"url": f"{BASE_URL}=13&subtype=1", "label": ""},
    4: {"url": f"{BASE_URL}=4&subtype=1", "label": ""},
    ...
    8: {"url": f"{BASE_URL}=8&subtype=1", "label": "6"},
}
